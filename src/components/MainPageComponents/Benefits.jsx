				...
				<ul className="ml-7 max-w-[394px]">
					<li className="flex mb-10">
						...
						<div className="ml-5 flex flex-col">
							<Heading3 className="mb-2.5">Работаем как часы</Heading3>
					...
					<li className="flex mb-10">
						...
						<div className="ml-5 flex flex-col">
							<Heading3 className="mb-2.5">Чётко следуем ТЗ</Heading3>
					...
					<li className="flex mb-10">
						...
						/>
						<div className="ml-5 flex flex-col">
							<Heading3 className="mb-2.5">Для нас нет невозвожного</Heading3>
							<Body2>Мы никогда не заставляем заказчика ждать</Body2>
						</div>
					</li>
					<li className="flex">
