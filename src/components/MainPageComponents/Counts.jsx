...
export const Counts = () => {
	...
	return (
		<section
			...
			id="cta"
            data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" data-aos-offset='400'
		>
			<div className='flex gap-8 flex-row items-center justify-center w-[1200px] h-[520px]'>
                <div className='countsImage w-[397px] h-full' data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                    <img
                      src={notebook}
                ...
                <div className='bg-transparent w-[772px] h-[339px]' data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
